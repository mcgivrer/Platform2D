...
public class DemoScene extends Platform2D.AbstractScene {
    ...
    private void createHUD(Platform2D app, Platform2D.GameObject player) {
        Platform2D.Renderer renderer = app.getRenderer();
    ...
    public void keyReleased(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            case KeyEvent.VK_PAGE_UP -> {
                ...
                addEnemies(renderer, nbEnemeisToAdd);
            }
        }
    }

    private void addEnemies(Platform2D.Renderer renderer, int nbEnemies) {
